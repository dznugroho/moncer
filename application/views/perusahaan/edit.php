		...
		<?php endif;?>
          ...
          <div class="card">
		    <div class="card-header">
              ...
              <div class="row">
                <a href="<?= site_url('user/perusahaan')?>" class="btn btn-primary"><i class="fas fa-arrow-left"> Kembali</a></i>
              </div>
              </div>
            </div>
            <div class="card-body">
              <form method="POST" action="<?php echo base_url('user/perusahaan/update')?>" enctype="multipart/form-data">
			  <div class="row">
                <div class="form-group col-6">
                    <label for="">Username*</label>
					<input type="text" class="form-control <?php echo form_error('username') ? 'is-invalid':'' ?>" 
					name="username" placeholder="Masukkan Username Anda" value="<?= $perusahaan->username ?>">
                ...
                <div class="form-group col-6">
					...
					name="name" placeholder="Masukkan Nama Anda" value="<?= $perusahaan->name ?>">
					<div class="invalid-feedback">
			  ...
			  <div class="row">
			   <div class="form-group col-6">
					...
					name="email" placeholder="Masukkan Email Anda" value="<?= $perusahaan->email ?>">
					<div class="invalid-feedback">
			  ...
			  <div class="row">
				<div class="form-group col-6">
					...
					<?php foreach($kecamatans as $data):?>
						<option <?php if($data->id == $perusahaan->kecamatan){ echo 'selected="selected"'; } ?> value="<?php echo $data->id ?>">
				...
				<div class="form-group col-6">
					...
					<?php foreach($desas as $item):?>
						...
						<?php if ($item->kecamatan_id == $perusahaan->kecamatan) { ?>

						<option <?php if($item->id == $perusahaan->desa){ echo 'selected="selected"'; } ?> value="<?php echo $item->id ?>">
			  ...
			  <div class="row">
				<div class="form-group col-6">
					...
					name="alamat" placeholder="Masukkan Alamat Anda" value="<?= $perusahaan->alamat ?>">
					<div class="invalid-feedback">
				...
				<div class="form-group col-6">
					...
					name="no_telp" placeholder="Masukkan No.Telp Anda" value="<?= $perusahaan->no_telp ?>">
					<div class="invalid-feedback">
