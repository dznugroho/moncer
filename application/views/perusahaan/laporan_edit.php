          ...
          <div class="card">
			...
			<div class="table-responsive">
                <table class="table table-sm" id="table-1">
					<tr>
						<th colspan ="6">	
						<div class="alert alert-primary mb-2 mt-0" role="alert">PELAPORAN PELAKSANAAN KEGIATAN CSR</div>
						</th>	
					</tr>
					<tr>
					...
					<tr>
						<td>
							<a href="<?= site_url('csr/laporan_kegiatan')?>" class="btn btn-primary btn-sm">
			...
			<form method="POST" action="<?php echo base_url('csr/laporan_kegiatan/update')?>" enctype="multipart/form-data">
			...
			<input type="hidden" class="form-control" name="csr_id" 
				value="<?php echo $laporan->csr_id ;?>">
			
			  
			  <div class="row">
			  	<div class="form-group col-6">
                    <label for="">Capaian Jumlah Target Terpenuhi</label>
					<input type="text" class="form-control <?php echo form_error('jumlah_target') ? 'is-invalid':'' ?>" 
					name="jumlah_target" value="<?= $laporan->jumlah_target ;?>">
					<div class="invalid-feedback">
					<?php echo form_error('jumlah_target') ?>
					</div>
				</div>
				<div class="form-group col-6">
                    <label for="">Pagu Anggaran Terpenuhi</label>
					<input type="text" class="form-control <?php echo form_error('dana_akhir') ? 'is-invalid':'' ?>" 
					name="dana_akhir" id="dana_akhir" value="<?= $laporan->dana_akhir; ?>">
					<div class="invalid-feedback">
			  ...
			  <div class="row">
			 	<div class="form-group col-6">
					...
					name="tgl_selesai" value="<?= $laporan->tgl_selesai; ?>">
					<div class="invalid-feedback">
					<?php echo form_error('tgl_selesai') ?>
					</div>
				</div>
			  	<div class="form-group col-6">
                    <label for="">File Laporan</label><span class="text-danger mb-1"> (PDF|DOC|DOCX)</span>
					<input type="file" class="form-control" name="file_laporan">
					<input type="hidden" name="old_file" value="<?php echo $laporan->file_laporan ;?>" />
				</div>
...
<script type="text/javascript">
	...
	var rupiah = document.getElementById('dana_akhir');
