                ...
                <table class="table table-sm" id="mytable">
					...
					?>
						<tr>
							...
							<!-- <td class="td-btn">
								<a href="<?php echo site_url('usulan/konfirmasi_usulan/show/'.$data->id);?>" class="btn btn-info btn-md"> Detail</a>
							</td> -->
...
<div class="modal fade" id="validasiModal<?php echo $row->id;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <div class="modal-header">
                <h4 class="modal-title" id="modal_edit">Konfirmasi Usulan</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form class="form-horizontal" method="post" action="<?php echo base_url('usulan/konfirmasi_usulan/validasi')?>">
