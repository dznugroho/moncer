                ...
                <table class="table table-striped hover" id="table-1">
					...
					?>
						<tr>
							...
							<td class="td-btn">
								<a href="<?php echo site_url('usulan/usulan_masuk/show/'.$data->id);?>" class="btn btn-info btn-md"> Detail</a>
							</td>
							<td class="td-btn">
								<a onclick="approveConfirm('<?php echo site_url('usulan/usulan_masuk/terima/'.$data->id) ;?>')" 
								href="#" class="btn btn-success btn-md"> Terima</a>
							</td>
							<td class="td-btn">
								<button data-toggle="modal" data-target="#rejectModal<?php echo $data->id;?>" class="btn btn-danger btn-md"> Tolak</button>
