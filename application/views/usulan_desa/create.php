      ...
      <div class="row">
		...
		<?php endif;?>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <form method="POST" action="<?php echo base_url('desa/pengajuan_usulan/store')?>" enctype="multipart/form-data">
			  ...
			  <div class="form-group col-6">
					...
					name="nama_kegiatan" value="<?= set_value('nama_kegiatan') ?>">
			  ...
			  <!-- <div class="row">
			   <div class="form-group col-6">
					...
					name="waktu_mulai" value="<?= set_value('waktu_mulai') ?>">
					<div class="invalid-feedback">
				...
				<div class="form-group col-6">
					...
					name="waktu_selesai" value="<?= set_value('waktu_selesai') ?>">
					<div class="invalid-feedback">
			  ...
			  <div class="row">
				<div class="form-group col-6">
					...
					name="alamat_kegiatan" value="<?= set_value('alamat_kegiatan') ?>">
					<div class="invalid-feedback">
			  ...
			  <div class="form-group col-6">
				...
				<div class="form-group col-6">
					...
					<?php foreach($kecamatans as $data):?>
						<option <?php if($data->id == $this->session->userdata('kecamatan'))
			  ...
			  <div class="form-group col-6">
					...
					<?php foreach($desas as $item):?>
						<option <?php if($item->id == $this->session->userdata('desa'))
